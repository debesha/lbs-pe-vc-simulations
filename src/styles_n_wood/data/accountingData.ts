import { RawAccountingYear } from '../types'
import { enrichAccountingData } from '../utils/enrichAccountingData'

const rawAccountingData: { title: string; years: RawAccountingYear[] } = {
...
export const accountingData = enrichAccountingData(rawAccountingData)
